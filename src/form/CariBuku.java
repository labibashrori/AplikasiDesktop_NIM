 ...
 */
public class CariBuku extends javax.swing.JInternalFrame {
    String sql;
        ...
        try{
            if (aksi=="cari"){
                sql = "SELECT * FROM tb_buku WHERE "
                        + "kode_buku LIKE '%"+kataKunci+"%' OR "
                        + "judul_buku LIKE '%"+kataKunci+"%' OR "
                        + "penulis_buku LIKE '%"+kataKunci+"%' OR "
                        + "penerbit_buku LIKE '%"+kataKunci+"%'";
            }else{
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PENCARIAN DATA BUKU");
    ...
    private void btnPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPilihActionPerformed
        ...
        try {
            ...
            pinjam.ambilBuku(
                    ...
                    jtblBuku.getValueAt(jtblBuku.getSelectedRow(), 2).toString(), 
                    jtblBuku.getValueAt(jtblBuku.getSelectedRow(), 3).toString()
            );
            pinjam.pack();
